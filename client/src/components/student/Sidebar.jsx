...
export default function DashboardSidebar({ isOpen: isOpenProp, setIsOpen: setIsOpenProp }) {
  ...
  const menuItems = [
    ...
    { id: 'myevents', label: 'My Events', icon: Users, color: 'from-purple-500 to-pink-500' },
    { id: 'leaderboard', label: 'Leaderboard', icon: BarChart3, color: 'from-green-500 to-emerald-500' },
