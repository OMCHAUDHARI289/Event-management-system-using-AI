  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 flex relative overflow-hidden">
      ...
      <style>{`
        ...
        .card-3d { transform-style: preserve-3d; transition: transform 0.6s cubic-bezier(0.23, 1, 0.32, 1); }
        .card-3d:hover { transform: translateZ(20px) rotateY(5deg); }
        .card-3d.active { transform: translateZ(30px) scale(1.05); }
      `}</style>
      ...
      <div className="relative z-10 w-full">
        ...
        {/* Main Content - only width changes, content below header */}
        {/* Main Content - full height, below header, shifts right with sidebar */}
